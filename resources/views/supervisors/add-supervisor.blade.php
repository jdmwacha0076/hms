<head>
    ...
    <title>Sajili Wasimamizi | Usimamizi wa Nyumba</title>
            ...
            <div class="card mb-4" style="margin-bottom: -30px !important;">
                ...
                <div class="cardheader">
                    <div class="card-header">
                        <h5 class="mb-1" style="text-align: center;">Sajili wasimamizi</h5>
                    </div>
                </div>
                ...
                <div class="panel-body" style="padding: 10px;">
                    ...
                    <form method="POST" action="{{ route('supervisors.save') }}" onsubmit="disableButton('add-tenant')">
                        ...
                        <div class="form-group">
                            <label for="supervisor_name" class="font-weight-bold">1. Jina la msimamizi:</label>
                            <input type="text" class="form-control" name="supervisor_name" placeholder="Jaza jina la msimamizi kwa hapa" required>
                        </div>
